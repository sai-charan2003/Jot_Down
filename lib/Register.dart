...
class _RegisterState extends State<Register> {
  ...
  Widget build(BuildContext context) {
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(bottom: 40.0),
                        child: Container(alignment:Alignment.bottomCenter,child: Text('Register to ',style: GoogleFonts.quicksand(fontSize: 20,fontWeight: FontWeight.w900),),),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 40.0),
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(labelText: "Password",labelStyle: GoogleFonts.quicksand(fontWeight: FontWeight.w200,color: Colors.black),
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(labelText: "Confirm  Password",labelStyle: GoogleFonts.quicksand(fontWeight: FontWeight.w500,color: Colors.black),
            ...
            Padding(
              ...
              child: Material(
                ...
                if(emailtextcontroller.text=="" || passwordtextcontroller.text==""|| passwordconfirm.text==""){
    ...
    type: AnimatedSnackBarType.warning,
                ...
                else if(passwordtextcontroller.text!=passwordconfirm.text){
                  AnimatedSnackBar.material(
                    'Password Incorrect',
                ...
                child: Text('Create Account',style: GoogleFonts.roboto(color: Colors.white,fontSize: 24.0,),),
              ),
              )
              ),
            ),
