    ...
    return SafeArea(child: Scaffold(
      ...
      body: Stack(children:  <Widget>[
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              return GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,),
                ...
                return GestureDetector(
                  onTap: (){Navigator.push(context,PageTransition(child: edit(snapshot.data!.docs[index],note), type: PageTransitionType.fade));},
                  child: Card(
                    shape: RoundedRectangleBorder(
                      side: BorderSide(color: Colors.black,),borderRadius: BorderRadius.circular(20.0)
                    ),
        ...
        Padding(
          ...
          child: Container(alignment: Alignment.topLeft,child: Text('Jot Down',style: GoogleFonts.quicksand(fontSize: 30,fontWeight: FontWeight.w900,color: Colors.black),)),
        ),
        Padding(
          ...
          child: Container(
            ...
            child: ElevatedButton(onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>Note(widget.user)));
